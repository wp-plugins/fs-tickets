...
global $user_ID;
	...
	if (isset($_POST['submit'])) {
		if (
			...
			mail(get_bloginfo('admin_email'), 'New Support Ticket', 'A new support ticket has been created entitled "'.$_POST['ticket_title'].'". You can view your support ticket here: <a href="'.get_bloginfo('wpurl').'/'.$FSTPages['TicketsURL'].'/'.$_POST['ticket_url'].'/">'.get_bloginfo('wpurl').'/'.$FSTPages['TicketsURL'].'/'.$_POST['ticket_url'].'/</a>', $headers);
